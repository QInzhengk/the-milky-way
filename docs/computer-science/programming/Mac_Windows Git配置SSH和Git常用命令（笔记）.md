...
## 二、Git常用命令
![Git](/1a3a3c5729069037bddfeee8f6953869.png)

![在这里插入图片描述](/7e6547dbf29d85265da7e27f7a4e40d8.png)
说明：
 - workspace：工作区 
...
```bash
git checkout zk_gle_ient.py
# error: 路径规格 'qk_gole_clnt.py' 未匹配任何 git 已知文件
```
...
未跟踪的文件:
  （使用 "git add <文件>..." 以包含要提交的内容）
	...
	../metis/q.py
	../metics/zhkai.sh
	../user_yis/clt_og_21226/
	../useralyis/et_pv.py
	../user_sis/runt_pv.sh
	../user_yis/ruiic_day.sh
	../usersis/seer_econdlow_.json
	k_goe_lnt.py
```
...
$ git archive
```
参考：[https://gitee.com/all-about-git](https://gitee.com/all-about-git)
![在这里插入图片描述](/1722f6e890dc6f678b7d4c6e81b3566f.png)

@[TOC](Github首页美化)
## [https://github.com/QInzhengk](https://github.com/QInzhengk)
## 一、新建仓库
对Github首页进行美化，需要新建一个仓库名和自己 Github 用户名相同的仓库；并且需要添加一个 README.md自述文件即可。
![新建和用户名相同的仓库](/68dfde048356ccc8a48abe37d8698b58.png)
...
```
## 界面展示
![示例](/5fe2f2869c454fef3f3ff9762649696a.png)

更加炫酷的美化方法可参考以下：
1.[https://wakatime.com/plugins/status](https://wakatime.com/plugins/status)
2.[https://github.com/anuraghazra/github-readme-stats](https://github.com/anuraghazra/github-readme-stats)
3.[https://github.com/sun0225SUN](https://github.com/sun0225SUN)

## 三、GitHubDesktop汉化工具
[https://github.com/robotze/GithubDesktopZhTool](https://github.com/robotze/GithubDesktopZhTool)

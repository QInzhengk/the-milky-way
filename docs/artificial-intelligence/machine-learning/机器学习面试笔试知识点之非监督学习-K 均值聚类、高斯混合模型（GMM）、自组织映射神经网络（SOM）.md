...
K-均值是一个迭代算法，假设我们想要将数据聚类成 n 个组，其方法为:
 ...
 - 重复步骤，直至中心点不再变化。
用 
![在这里插入图片描述](/2299bf2b7e584addbec184e90c23ad41.png)
...
![添加图片注释，不超过 140 字（可选）](/a38d8e32e6b4411d8d6be9d0b31d223c.png)

## 2.2 损失函数
K-均值最小化问题，是要最小化所有的数据点与其所关联的聚类中心点之间的距离之和，因此 K-均值的代价函数（又称畸变函数 Distortion function）为：

![添加图片注释，不超过 140 字（可选）](/2933c6c119a4490e8b38a2db84a7be56.png)
...
![添加图片注释，不超过 140 字（可选）](/427c00dc4ce6400f9a4538d46257791e.png)
...
![添加图片注释，不超过 140 字（可选）](/e66c159aa6fe4de99e66a2887bd52242.png)
...
![添加图片注释，不超过 140 字（可选）](/26bf39e0f269496bbe1e7e47aa83d25d.png)


![添加图片注释，不超过 140 字（可选）](/3eed67e4698a42d3a9e2469be78bc9f1.png)

高斯混合模型的核心思想是，假设数据可以看作从多个高斯分布中生成出来的。在该假设下，每个单独的分模型都是标准高斯模型，其均值  和方差  是待估计的参数。此外，每个分模型都还有一个参数  ，可以理解为权重或生成数据的概率。高斯混合模型的公式为：

![添加图片注释，不超过 140 字（可选）](/7f278a0c2950431785a1749a6074ca40.png)

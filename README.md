...
│   ├── links/                    # 学习资源
│   │   ├── index.md              # 学习资源首页
│   │   ├── 数学建模与AI学习资源全景整理.md  # 完整学习资源
│   │   └── AI时代：从编程到价值创造.md  # AI时代指南
│   └── index.md                  # 首页
├── package.json                   # 项目配置
└── README.md                      # 项目说明
```
...
### 📚 精选学习资源
- **[数学建模与AI学习资源全景整理](docs/links/数学建模与AI学习资源全景整理：从竞赛真题、经典教材到机器学习、深度学习与大模型实战.md)**：从竞赛真题、经典教材到机器学习、深度学习与大模型，提供系统化学习路径
- **[AI时代：从编程到价值创造](docs/links/AI时代：从编程到价值创造——人人必须学会与AI共舞.md)**：深入解析AI时代变革，从"写代码"到"做价值"，人人必须学会与AI共舞
- **[APS系统与OR-Tools完全指南](docs/mathematical-modeling/APS系统与OR-Tools完全指南：智能排产与优化算法实战解析.md)**：智能排产与优化算法实战解析，涵盖生产计划、排程优化
